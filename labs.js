...
total = Netflix + Hulu + Disney + YouTube_Premium + whoUsesPeacock
console.log(`$${total}`)
...
Hulu = Hulu - 7
whoUsesPeacock = whoUsesPeacock - 5
Netflix = Netflix - 7
// console.log(Hulu)
...
let newTotal = Netflix + Hulu + Disney + YouTube_Premium + whoUsesPeacock
